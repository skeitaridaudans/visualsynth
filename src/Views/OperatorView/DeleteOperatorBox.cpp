...
DeleteOperatorBox::DeleteOperatorBox(OperatorView *operatorView)
        : operatorView_(operatorView),
          scale_(1.0),
...
void DeleteOperatorBox::update() {
    ...
    if (operatorView_->primaryTouchPoint().isPressed &&
        isInsideBox(operatorView_->primaryTouchPoint().position)) {

        // The initial press
        if (operatorView_->touchPressHandledState_ == TouchEventHandledState::Unhandled) {
